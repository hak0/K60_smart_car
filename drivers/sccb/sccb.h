...
u8 sccb_refresh(void);

//--GPIO_DDR_1bit(PORTx,n,ddr)--//
#define SCL_OUT   GPIO_DDR_1bit(PORTC,6,1)      //SCL-PC6设置为输出端口
#define SDA_OUT   GPIO_DDR_1bit(PORTC,7,1)      //SDA-PC6设置为输出端口
#define SDA_IN    GPIO_DDR_1bit(PORTC,7,0)      //SDA-PC7设置为输入端口

//--GPIO_SET_1bit(PORTx,n,data)--//
#define SCL_HIGH  GPIO_SET_1bit(PORTC,6,1)
#define SCL_LOW   GPIO_SET_1bit(PORTC,6,0)
#define SDA_HIGH  GPIO_SET_1bit(PORTC,7,1)
#define SDA_LOW   GPIO_SET_1bit(PORTC,7,0)
#define SDA_DATA  GPIO_GET_1bit(PORTC,7) 
